<?php
  if (isset($_SERVER['HTTP_X_CSRF_TOKEN']) && isset($_COOKIE['_onlis_id'])) {
    ...
    if ($result["sccss"]) {
      ...
      $is_admin  = $result["group_id"] == 1;
      ?>
        <div class="row">
          <div class="col-12 mt-2 mb-3">
            <form id="formInfo" data-id="<?= $id ?>">
              <div class="row g-3">
                ...
                <div class="col-12">
                  <div class="d-flex align-items-center gap-3 flex-wrap">
                    ...
                    <!-- Группа/роль — только просмотр -->
                    <div class="d-flex align-items-center gap-2 px-3 py-1 border rounded-pill bg-light">
                      <i class="bi bi-shield-lock text-muted" style="font-size: 0.85rem;"></i>
                      <span class="fw-semibold small"><?= $result["group_name"] ?></span>
                    </div>

                    <!-- Свитч тренера — только для админа -->
