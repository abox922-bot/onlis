        ...
        <form id="formInfo">
          <div class="row">
              ...
              <select class="form-select form-select-sm form-inp" id="inpType" data-name="street-type" data-type="select" data-required="1">
                ...
                <?php
                  foreach ($result["types"] as $key => $value) {
                    ?>
                      <option value="<?php echo $value["id"]; ?>" <?php if($value["id"] == $result["type"]){echo "selected";} ?>><?php echo $value["name"]; ?></option>
                    <?php
                  }
                ?>
              </select>
            ...
            <div class="col-12 col-md-6 mb-2">
              ...
              <input type="text" class="form-control form-control-sm form-inp" id="inpName" data-name="street-name" data-type="text" data-required="1" value="<?php echo $result["name"]; ?>">
            </div>
