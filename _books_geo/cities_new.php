        ...
        <form id="formNew">
          <div class="row">
            ...
            <div class="col-12 col-md-6 mb-2">
              ...
              <input type="text" class="form-control form-control-sm" id="inpRegion" value="<?php echo $region_name; ?>" disabled>
            </div>
            <div class="col-12 mb-2">
              <label for="inpName" class="form-label mb-0">Название</label>
              <input type="text" class="form-control form-control-sm form-inp" id="inpName" data-name="city-name" data-type="text" data-required="1" value="">
            </div>
