...
$result = send_request(array_merge($ses_info, ['action' => 'object_staff_list', 'id' => $id]), 'objs');
    ...
    <table class="table table-sm table-hover mt-2">
        <tbody>
            <?php foreach ($result as $value): ?>
                <tr class="staffTr" data-id="<?php echo $value['id']; ?>" data-user-id="<?php echo $value['user_id']; ?>">
                    <td class="py-2" style="line-height: 1.2em;">
                        <span class="staffName" data-id="<?php echo $value['id']; ?>"><?php echo htmlspecialchars($value['name']); ?></span>
